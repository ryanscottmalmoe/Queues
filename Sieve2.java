...
import java.util.*;
import java.lang.*;
//ArrayDeque is faster than LinkedList by .044543 seconds on primes up to 10000.
//This class has a quicker computeTo.

public class Sieve2
{
   long sTimeSieve2; //Declaration of start time.
   long eTimeSieve2; //Declaration of end time.
   ...
   void computeTo(int n) throws IllegalArgumentException //Computes number of primes from 2 to the given n number.
   {
      try
      {
         if(n < 2)
      ...
      sTimeSieve2 = System.nanoTime();
      resultP = "";
      tCalls++;
      this.lastN = n;
      Queue<Integer> primes = new ArrayDeque<Integer>();
      Queue<Integer> allNums = new ArrayDeque<Integer>();
      for(int i = 2; i < n + 1; i++)
      {
         allNums.add(i);
      }
      ...
      eTimeSieve2 = System.nanoTime() - sTimeSieve2;
      double seconds = (double)eTimeSieve2 / 1000000000.0;
      // System.out.println();
